...
namespace ApiTraz.Models
{
    ...
    public partial class Tipos_de_Grupos: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int IdTipoGrupo
        {
            ...
            set
            {
                if (_idTipoGrupo != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("La propiedad 'IdTipoGrupo' forma parte de la clave del objeto y no se puede modificar. Solo se pueden realizar cambios en las propiedades de clave cuando no se realiza un seguimiento del objeto o su estado es Agregado.");
                    }
                    _idTipoGrupo = value;
        ...
        private void FixupGrupos(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Tipos_de_Grupos, this))
                    {
                        item.Tipos_de_Grupos = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
