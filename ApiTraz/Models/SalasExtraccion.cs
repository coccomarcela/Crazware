...
namespace ApiTraz.Models
{
    ...
    public partial class SalasExtraccion: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupGrupos(Grupos previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.SalasExtraccion.Contains(this))
            {
                previousValue.SalasExtraccion.Remove(this);
            }
    
            if (Grupos != null)
            {
                if (!Grupos.SalasExtraccion.Contains(this))
                {
                    Grupos.SalasExtraccion.Add(this);
                }
        ...
        private void FixupLoc(Loc previousValue, bool skipKeys = false)
        {
            ...
            if (Loc != null)
            {
                if (!Loc.SalasExtraccion.Contains(this))
                {
                    Loc.SalasExtraccion.Add(this);
                }
        ...
        private void FixupTiposSalas(TiposSalas previousValue)
        {
            ...
            if (TiposSalas != null)
            {
                if (!TiposSalas.SalasExtraccion.Contains(this))
                {
                    TiposSalas.SalasExtraccion.Add(this);
                }
        ...
        private void FixupMovSalasExtraccion(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.SalasExtraccion, this))
                    {
                        item.SalasExtraccion = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
